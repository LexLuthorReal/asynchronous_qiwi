QIWIErrorsID = {
    ...
    57: "Recipient's wallet status not allowing the money transfer. " +
        "Ask them to enter passport data in QIWI Wallet to increase status level.",
    131: "Payment type unavailable for your country.",
    166: "Your wallet status not allowing the money transfer. " +
         "Enter passport data in QIWI Wallet to increase status level.",
    167: "Recipient's wallet status not allowing the money transfer. " +
         "Ask them to enter passport data in QIWI Wallet to increase status level.",
    202: "Technical error. Repeat the payment later.",
    204: "Your wallet status not allowing the cash top up." +
         "Enter passport data in QIWI Wallet to increase status level.",
    220: "Not enough funds. Top up your wallet.",
    ...
    319: "Your wallet status not allowing the money transfer. " +
         "Enter passport data in QIWI Wallet to increase status level.",
    ...
    472: "Not enough funds on your wallet - top up it.",
    ...
    700: "Limit for your wallet current status is exceeded. " +
         "Increase your status level or check your current limit in Profile section of qiwi.com.",
    702: "Payment is not possible due to recipient's limit. " +
         "Its balance's limit is exceeded. Recipient has to contact with our Support.",
    704: "The monthly limit on your wallet has been exceeded. " +
         "To remove the restrictions, increase your wallet status in Profile section.",
    705: "The monthly limit on your wallet has been exceeded. " +
         "To remove the restrictions, increase your wallet status in Profile section.",
    ...
    716: "You have exceeded the monthly limit on withdrawals from the card. " +
         "To remove the restrictions, increase your wallet status in Profile section.",
    717: "You have exceeded the daily limit on withdrawals from the card. " +
         "To remove the restrictions, increase your wallet status in Profile section.",
    ...
    757: "The limit on the number of payments has been exceeded. " +
         "To remove the restrictions, increase your wallet status in Profile section.",
    ...
    866: "Payment not processed. " +
         "Limit on outgoing transfers has been exceeded - 5 000 RUB from RUB, USD, EUR accounts to KZT monthly. " +
         "Increase your wallet status in Profile section and pay without limits.",
    867: "Payment not processed. " +
         "Limit on incoming transfers has been exceeded - 5 000 RUB from RUB, USD, EUR accounts to KZT monthly. " +
         "Increase your wallet status in Profile section and pay without limits.",
    893: "Transfer rejected. Date is expired.",
    901: "The code to confirm the payment has expired. Repeat the payment.",
    943: "The limit on transfers per month is exceeded. " +
         "Increase your wallet status in Profile section and transfer without restrictions.",
    1050: "The limit on such operations is exceeded. " +
          "Increase your wallet status in Profile section and expand your options.",
